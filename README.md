...
[
  {
    ...
    "Tag": "v1.2.0",
    "API Compatible Tags": ["v1.0.0", "v1.1.0", "v1.1.5"]
  }
]
```
...
[
  {
    ...
    "Base Path": "../shared/database-utils",
    "Tag": "v1.2.0",
    "API Compatible Tags": ["v1.1.0", "v1.1.5"]
  }
]
```
...
[
  {
    ...
    "Tag": "v3.1.0",
    "API Compatible Tags": ["v3.0.0", "v3.0.5", "v3.0.8"]
  }
]
```
...
[
  {
    ...
    "Tag": "v2.3.0",
    "API Compatible Tags": ["v2.1.0", "v2.2.0", "v2.2.5"]
  },
  {
    "Repository URL": "https://github.com/yourorg/CommonControls.git",
    "Base Path": "../shared/common-controls",
...
When filling out the "API Compatible Tags" field, consider:

1. **Breaking Changes**: Only include versions that are truly API-compatible
2. **Testing History**: Look at which versions have been tested together
3. **Git History**: Use `git log --oneline` to review what changed between versions
4. **Semantic Versioning**: If you follow semver, patch and minor versions are typically compatible
...
# If no breaking changes: include v1.0.0, v1.1.0, v1.1.5 in API Compatible Tags
```
